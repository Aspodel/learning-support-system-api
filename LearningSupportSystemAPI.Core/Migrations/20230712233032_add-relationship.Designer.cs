...
namespace LearningSupportSystemAPI.Core.Migrations
{
    ...
    [Migration("20230712233032_add-relationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentClassToDoItem", b =>
                {
                    ...
                    b.HasKey("ToDoItemsId", "StudentsStudentId", "StudentsClassId");

                    b.HasIndex("StudentsStudentId", "StudentsClassId");

                    b.ToTable("StudentClassToDoItem");
                });
            ...
            modelBuilder.Entity("StudentClassToDoItem", b =>
                {
                    b.HasOne("LearningSupportSystemAPI.ToDoItem", null)
                        .WithMany()
                        .HasForeignKey("ToDoItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LearningSupportSystemAPI.StudentClass", null)
                        .WithMany()
                        .HasForeignKey("StudentsStudentId", "StudentsClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
