        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_Rooms_FacultyOfficeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FeePerCredit = table.Column<int>(type: "int", nullable: true),
                    DepartmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscussionUser", x => new { x.DiscussionsId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_DiscussionUser_AspNetUsers_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseMajor", x => new { x.CourseProgramId, x.MajorsId });
                    table.ForeignKey(
                        name: "FK_CourseMajor_Courses_CourseProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentClass_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeColumnId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[FacultyOfficeId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionUser_ParticipantsId",
                table: "DiscussionUser",
                column: "ParticipantsId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeColumns_ClassId",
                table: "GradeColumns",
                column: "ClassId");
